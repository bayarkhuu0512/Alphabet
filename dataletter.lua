...
L.letters[5].imgNormal = 'images/Ve.png'
L.letters[5].imgWhite = 'images/Ve_white.png'
...
L.letters[8].imgWhite = 'images/E_white.png'
...
L.letters[9].imgWhite = 'images/E_white.png'
